                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        <div className="section-title text-center mb-5">
                            ...
                            <p>i am a vibrant curious developer inhabiting the cape town tech space. i am also a foodie and
                                a fantasy enthusiast.</p>
                        </div>
                    </div>
                </div>
                <div className="row">
                        ...
                        <div className="about-content mt-50 text-center">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <p>The Lefela legacy is one rich in history... lefela men from times of old achieved greatness
                                        in being selfless and helping others
                                ...
                                <li>
                                    <div className="single-info d-flex align-items-center">
                                        ...
                                        <div className="info-text">
                                            <p><span>Date of birth:</span> 26 February 1990</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div className="single-info d-flex align-items-center">
                                        ...
                                        <div className="info-text">
                                            <p><span>Email:</span> rakgew@gmail.com</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div className="single-info d-flex align-items-center">
                                        ...
                                        <div className="info-text">
                                            <p><span>Phone:</span> +27 (0) 78 375 4146</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="single-info d-flex align-items-center">
                                        ...
                                        <div className="info-text">
                                            ...
                                            <p><span>Location:</span> cape Town</p>
