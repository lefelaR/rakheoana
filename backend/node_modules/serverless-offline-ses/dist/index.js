...
let NODE_MODULES_PATH = path_1.join(process.cwd(), "./node_modules/.bin");
if (!fs_1.existsSync(path_1.join(NODE_MODULES_PATH, "aws-ses-local"))) {
    NODE_MODULES_PATH = path_1.join(__dirname, "..", "./node_modules/.bin");
}
